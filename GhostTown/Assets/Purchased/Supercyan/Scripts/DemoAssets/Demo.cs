...
public class Demo : MonoBehaviour
{
    ...
    [SerializeField] private CameraLogic m_cameraLogic = null;
    [SerializeField] private string[] m_animations = { "Pickup", "PickupFast", "ButtonPress", "Throw", "Win", "Lose", "Lose2", "Wave", "Yes", "No", "Shrug", "Conversation", "Dance" };
